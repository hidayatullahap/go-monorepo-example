...
var file_golang_pkg_proto_users_users_proto_rawDesc = []byte{
	...
	0x22, 0x0c, 0x0a, 0x0a, 0x4e, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x6b,
	...
	0x09, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x32, 0x69, 0x0a, 0x05, 0x55,
...
var file_golang_pkg_proto_users_users_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_golang_pkg_proto_users_users_proto_goTypes = []interface{}{
	...
	(*NoResponse)(nil),    // 2: users.NoResponse
...
var file_golang_pkg_proto_users_users_proto_depIdxs = []int32{
	...
	3, // 1: users.Users.CreateUser:input_type -> users.User
	1, // 2: users.Users.Hello:output_type -> users.HelloResponse
	2, // 3: users.Users.CreateUser:output_type -> users.NoResponse
